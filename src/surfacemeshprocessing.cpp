...
void SurfaceMeshProcessing::createActions()
{
	...
	AnisotropicAction = new QAction("Anisotropic", this);
	connect(AnisotropicAction, SIGNAL(triggered()), this, SLOT(Anisotropic_test()));
...
//	LiuhaoToolBar = addToolBar(tr("My Function"));
//	LiuhaoToolBar->addAction(AnisotropicAction);
}
...
void SurfaceMeshProcessing::Anisotropic_test()
{
	viewer->Anisotropic_test();
}
